...
def build_scrapy_command(origin, destination, departure_date, return_date=None):
    ...
    cmd = [
        'scrapy', 'crawl', 'flights_spider_simple',  # Using simple version first
        '-a', f'origin={origin}',
...
if __name__ == "__main__":
    run_flight_search()
        print("=" * 50)
        print("🔍 Generating demo flight data (for testing)")
        print("💡 Note: This is demo data to test the system")
        ...
        print("\n⏳ Generating sample flight data...")
        print("📊 Results will be saved to data/raw/flights/")
        print("=" * 50)
        
        # Run the scraper
        result = subprocess.run(cmd, cwd='../scrapers/')
